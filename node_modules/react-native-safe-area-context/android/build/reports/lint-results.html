...
Check performed at Mon Mar 21 02:52:39 BRT 2022      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/java/com/th3rdwave/safeareacontext/SafeAreaUtils.kt">../../src/main/java/com/th3rdwave/safeareacontext/SafeAreaUtils.kt</a>:56</span>: <span class="message">Unnecessary; SDK_INT is always >= 29</span><br /><pre class="errorlines">
<span class="lineno">  53 </span>private <span class="keyword">fun</span> getRootWindowInsetsCompat(rootView: View): EdgeInsets? {
<span class="lineno">  54 </span>  <span class="keyword">return</span> <span class="keyword">when</span> {
<span class="lineno">  55 </span>    Build.VERSION.SDK_INT >= Build.VERSION_CODES.R -> getRootWindowInsetsCompatR(rootView)
<span class="caretline"><span class="lineno">  56 </span>    <span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span> -> getRootWindowInsetsCompatM(rootView)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  57 </span>    <span class="keyword">else</span> -> getRootWindowInsetsCompatBase(rootView)
