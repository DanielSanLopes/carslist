...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 7 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Mon Mar 21 02:53:11 BRT 2022      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ObsoleteSdkInt"><i class="material-icons warning-icon">warning</i>Obsolete SDK_INT Version Check (2)</a>
      ...
      <a class="mdl-navigation__link" href="#ViewConstructor"><i class="material-icons warning-icon">warning</i>Missing View constructors for XML inflation (2)</a>
    </nav>
  </div>
...
<tr>
<td class="countColumn">2</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#ViewConstructor">ViewConstructor</a>: Missing View constructors for XML inflation</td></tr>
...
<span class="location"><a href="../../../../../../.gradle/caches/transforms-3/ce06176d96320a8fd09a8285cf3e6af2/transformed/fragment-1.2.1/jars/lint.jar">../../../../../../.gradle/caches/transforms-3/ce06176d96320a8fd09a8285cf3e6af2/transformed/fragment-1.2.1/jars/lint.jar</a></span>: <span class="message">Lint found an issue registry (<code>androidx.fragment.lint.FragmentIssueRegistry</code>) which is older than the current API level; these checks may not work correctly.<br/>
<br/>
Recompile the checks against the latest version. Custom check API version is 6 (3.6), current lint API level is 8 (4.1)</span><br />

Applies to variants: debug<br/>
Does <b>not</b> apply to variants: release<br/>
</div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:10</span>: <span class="message">A newer version of com.android.tools.build:gradle than 4.2.2 is available: 7.1.2</span><br /><pre class="errorlines">
<span class="lineno">   7 </span>      mavenCentral()
<span class="lineno">   8 </span>  }
<span class="lineno">   9 </span>  dependencies {
<span class="caretline"><span class="lineno">  10 </span>      <span class="warning">classpath(<span class="string">'com.android.tools.build:gradle:4.2.2'</span>)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  11 </span>      classpath <span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:${safeExtGet('kotlinVersion', '1.4.10')}"</span>
<span class="lineno">  12 </span>      classpath <span class="string">"com.diffplug.spotless:spotless-plugin-gradle:5.15.0"</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.kt">../../src/main/java/com/swmansion/rnscreens/ScreenStackHeaderConfig.kt</a>:88</span>: <span class="message">Unnecessary; SDK_INT is always >= 29</span><br /><pre class="errorlines">
<span class="lineno">  85 </span>  <span class="comment">// we want to save the top inset before the status bar can be hidden, which would resolve in</span>
<span class="lineno">  86 </span>  <span class="comment">// inset being 0</span>
<span class="lineno">  87 </span>  <span class="keyword">if</span> (headerTopInset == <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno">  88 </span>      headerTopInset = <span class="keyword">if</span> (<span class="warning">Build.VERSION.SDK_INT >= Build.VERSION_CODES.M</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  89 </span>          rootWindowInsets.systemWindowInsetTop
<span class="lineno">  90 </span>      <span class="keyword">else</span>
<span class="lineno">  91 </span>      <span class="comment">// Hacky fallback for old android. Before Marshmallow, the status bar height was always 25</span></pre>

<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt">../../src/main/java/com/swmansion/rnscreens/ScreenWindowTraits.kt</a>:84</span>: <span class="message">Unnecessary; SDK_INT is never &lt; 29</span><br /><pre class="errorlines">
<span class="lineno">  81 </span>  }
<span class="lineno">  82 </span>
<span class="lineno">  83 </span>  internal <span class="keyword">fun</span> setStyle(screen: Screen, activity: Activity?, context: ReactContext?) {
<span class="caretline"><span class="lineno">  84 </span>      <span class="keyword">if</span> (activity == <span class="keyword">null</span> || context == <span class="keyword">null</span> || <span class="warning">Build.VERSION.SDK_INT &lt; Build.VERSION_CODES.M</span>) {&nbsp;</span>
<span class="lineno">  85 </span>          <span class="keyword">return</span>
<span class="lineno">  86 </span>      }
<span class="lineno">  87 </span>      <span class="keyword">val</span> screenForStyle = findScreenForTrait(screen, WindowTraits.STYLE)
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt">../../src/main/java/com/swmansion/rnscreens/ScreenStackFragment.kt</a>:161</span>: <span class="message">Prefer "<code>SHOW_AS_ACTION_IF_ROOM</code>" instead of "<code>SHOW_AS_ACTION_ALWAYS</code>"</span><br /><pre class="errorlines">
<span class="lineno"> 158 </span>                onSearchViewCreate?.invoke(newSearchView)
<span class="lineno"> 159 </span>            }
<span class="lineno"> 160 </span>            <span class="keyword">val</span> item = menu.add(<span class="string">""</span>)
<span class="caretline"><span class="lineno"> 161 </span>            item.setShowAsAction(MenuItem.<span class="warning">SHOW_AS_ACTION_ALWAYS</span>)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 162 </span>            item.actionView = searchView
...
Dismiss</button>            </div>
          ...
          </section><a name="ViewConstructor"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="ViewConstructorCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Missing View constructors for XML inflation</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/CustomSearchView.kt">../../src/main/java/com/swmansion/rnscreens/CustomSearchView.kt</a>:8</span>: <span class="message">Custom view <code>CustomSearchView</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno">  5 </span>import androidx.appcompat.widget.SearchView
<span class="lineno">  6 </span>import androidx.fragment.app.Fragment
<span class="lineno">  7 </span>
<span class="caretline"><span class="lineno">  8 </span><span class="keyword">class</span> <span class="warning">CustomSearchView</span>(context: Context, fragment: Fragment) : SearchView(context) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  9 </span>    <span class="comment">/*
</span><span class="lineno"> 10 </span><span class="comment">        CustomSearchView uses some variables from SearchView. They are listed below with links to documentation
</span><span class="lineno"> 11 </span><span class="comment">        isIconified - https://developer.android.com/reference/android/widget/SearchView#setIconified(boolean)
</span></pre>

<span class="location"><a href="../../src/main/java/com/swmansion/rnscreens/CustomToolbar.kt">../../src/main/java/com/swmansion/rnscreens/CustomToolbar.kt</a>:7</span>: <span class="message">Custom view <code>CustomToolbar</code> is missing constructor used by tools: <code>(Context)</code> or <code>(Context,AttributeSet)</code> or <code>(Context,AttributeSet,int)</code></span><br /><pre class="errorlines">
<span class="lineno"> 4 </span>import androidx.appcompat.widget.Toolbar
<span class="lineno"> 5 </span>
<span class="lineno"> 6 </span><span class="comment">// This class is used to store config closer to search bar</span>
<span class="caretline"><span class="lineno"> 7 </span>open <span class="keyword">class</span> <span class="warning">CustomToolbar</span>(context: Context, <span class="keyword">val</span> config: ScreenStackHeaderConfig) : Toolbar(context)&nbsp;&nbsp;</span>
</pre>

</div>
<div class="metadata"><div class="explanation" id="explanationViewConstructor" style="display: none;">
...
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">ViewConstructor</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Usability</span>
</span>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 3/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationViewConstructorLink" onclick="reveal('explanationViewConstructor');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="ViewConstructorCardLink" onclick="hideid('ViewConstructorCard');">
Dismiss</button>            </div>
            </div>
          </section>
